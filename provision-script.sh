...
echo 'icpl123#' | sudo -S docker exec nginx-load-balancer service puppet stop
...
echo 'icpl123#' | sudo -S docker exec app-server-1 service puppet stop
...
echo 'icpl123#' | sudo -S docker exec app-server-2 service puppet stop
